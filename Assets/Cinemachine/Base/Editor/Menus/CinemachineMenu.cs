...
namespace Cinemachine.Editor
{
    public static class CinemachineMenu
    {
        ...
        private static void CreateBlendListCamera()
        {
            ...
            CinemachineBlendListCamera vcam = Undo.AddComponent<CinemachineBlendListCamera>(go);
            Selection.activeGameObject = go;

            // Give it a couple of children
            CinemachineVirtualCamera child1 = CreateDefaultVirtualCamera();
            Undo.SetTransformParent(child1.transform, go.transform, "create BlendListCam child");
            CinemachineVirtualCamera child2 = CreateDefaultVirtualCamera();
        ...
        private static void CreateClearShotVirtualCamera()
        {
            ...
            // Give it a child
            CinemachineVirtualCamera child = CreateDefaultVirtualCamera();
            Undo.SetTransformParent(child.transform, go.transform, "create ClearShot camera");
            CinemachineCollider collider = Undo.AddComponent<CinemachineCollider>(child.gameObject);
