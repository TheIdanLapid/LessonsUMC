...
namespace Cinemachine.Editor
{
    ...
    public class AboutWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            using (EditorGUILayout.VerticalScope vertScope = new EditorGUILayout.VerticalScope())
            {
            ...
            using (EditorGUILayout.ScrollViewScope scrollScope = new EditorGUILayout.ScrollViewScope(mReleaseNoteScrollPos, GUI.skin.box))
            {
