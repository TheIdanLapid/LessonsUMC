...
namespace Cinemachine.Editor
{
        ...
        : CinemachineVirtualCameraBaseEditor<CinemachineClearShot>
    {
        ...
        bool ObjectHasCollider(object obj)
        {
            ...
            CinemachineCollider collider = (vcam == null) ? null : vcam.GetComponent<CinemachineCollider>();
            ...
            mChildList.drawHeaderCallback = (Rect rect) =>
                {
                    ...
                    Vector2 textDimensions = GUI.skin.label.CalcSize(priorityText);
            ...
            mChildList.onAddCallback = (UnityEditorInternal.ReorderableList l) =>
                {
                    ...
                    CinemachineVirtualCamera vcam = CinemachineMenu.CreateDefaultVirtualCamera();
                    Undo.SetTransformParent(vcam.transform, Target.transform, "");
                    CinemachineCollider collider = Undo.AddComponent<CinemachineCollider>(vcam.gameObject);
